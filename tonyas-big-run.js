...
//          });
  ...
  Meteor.startup(function () {
    ...
    if (Achievements.find().count() === 0) {
      ...
      Achievements.insert({index : 0, from : null, description : "1st mile!",             condition : "1mi",    unlocked : false, unlockTime : null, hidden : false});
      Achievements.insert({index : 1, from : null, description : "Ran 6 miles.",          condition : "6mi",    unlocked : false, unlockTime : null, hidden : false});
      Achievements.insert({index : 2, from : null, description : "Ran 13 miles.",         condition : "13mi",   unlocked : false, unlockTime : null, hidden : false});
      Achievements.insert({index : 3, from : null, description : "Half marathon!",        condition : "13.1mi", unlocked : false, unlockTime : null, hidden : false});
      Achievements.insert({index : 4, from : null, description : "Ran 21 miles.",         condition : "21mi",   unlocked : false, unlockTime : null, hidden : false});
      Achievements.insert({index : 5, from : null, description : "Basically a marathon.", condition : "26.2mi", unlocked : false, unlockTime : null, hidden : false});
      Achievements.insert({index : 6, from : null, description : "Ran 40 miles.",         condition : "40mi",   unlocked : false, unlockTime : null, hidden : false});
    }
    // Update
    Meteor.call("update");
  });
...
//    }
  ...
  Template.stats.helpers({
    totalMiles : function () {
      return Stats.findOne({name : "total miles"});
    },
    week : function () {
